...
use App\Models\Movie; // Your model name here
...
class ProcessJsonData extends Command
{
    ...
    public function handle()
    {
        ...
        for($i = 1; $i <= 1; $i++) {
            $response = $client->request('GET', 'https://api.themoviedb.org/3/movie/popular?language=tr-TR&page=' . $i, [
                'headers' => [
