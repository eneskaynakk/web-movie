            ...
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                <div>
                    ...
                    <p class="max-w-xs mt-4 text-sm text-white">
                        2019 yılından bu yana film bilgi sistemleri sektöründe hizmet sunan tamamı yerli sermaye ile kurulmuş olan IAM sektörde güvenilir bir çözüm ortağı olmayı başarmıştır.
                    </p>
