<template>
    <footer class="bg-black shadow border-t">
        <div class="container py-16 mx-auto ">
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                <div>
                    <img :src="imgUrl" alt="" id="fotom" class="h-[86px] w-[110px]">
                    <p class="max-w-xs mt-4 text-sm text-white">
                        IAM, which was established entirely with domestic capital and has been providing services in the film industry since 2019, has managed to become a reliable solution partner in the sector.
                    </p>
                    <div class="flex mt-8 space-x-6 text-gray-600">
                        <a href="https://www.facebook.com/cetin.soyma.5/" class="hover:opacity-75" target="_blank" rel="noreferrer">
                        ...
                        <a href="https://www.instagram.com/enes_kynk/" class="hover:opacity-75" target="_blank" rel="noreferrer">
                        ...
                        <a href="https://x.com/eneskynk_" class="hover:opacity-75" target="_blank" rel="noreferrer">
                            <span class="sr-only"> Twitter </span>
                            <svg class="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                            </svg>
                        </a>
                        <a href="https://github.com/eneskaynakk" class="hover:opacity-75" target="_blank" rel="noreferrer">
...
import {getRoute} from "@utils/helpers.js";
