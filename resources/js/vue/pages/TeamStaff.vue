<template>
    ...
    <div class="text-center mx-auto mb-4 mt-12">
        <h2 class="text-2xl leading-normal mb-2 font-bold text-white dark:text-gray-100">
            Our Team <span class="font-light">Staff</span>
        </h2>
    ...
    <div class="w-full bg-black p-10 mb-24">
            ...
            <div role="list" aria-label="Behind the scenes People " class="lg:flex md:flex sm:flex items-center xl:justify-between flex-wrap md:justify-around sm:justify-around lg:justify-around">
                <div role="listitem" class="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
                    <div class="rounded overflow-hidden shadow-md bg-white">
                        <div class="absolute -mt-20 w-full flex justify-center">
                            <div class="h-32 w-32">
                                <img src="https://cdn-icons-png.flaticon.com/512/1920/1920952.png" class="bg-white img-small rounded-full">
                            </div>
                        </div>
                        <div class="px-6 mt-16">
                            <h1 class="font-bold text-3xl text-center mb-1">Enes KAYNAK</h1>
                            <p class="text-gray-800 text-sm text-center">Founder CEO</p>
                            <p class="text-center text-gray-600 text-base pt-3 font-normal">The CEO's role in raising a company's corporate IQ is to establish an atmosphere that promotes knowledge sharing and collaboration. The emphasis on innovation and technology in our.</p>
                            <div class="w-full flex justify-center pt-5 pb-5">
                                <a href="https://github.com/eneskaynakk" target="_blank" class="mx-5">
                                ...
                                <a href="https://x.com/eneskynk_" target="_blank" class="mx-5">
                                ...
                                <a href="https://www.instagram.com/enes_kynk/" target="_blank" class="mx-5">
                ...
                <div role="listitem" class="xl:w-1/3 lg:mx-3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
                    <div class="rounded overflow-hidden shadow-md bg-white">
                        ...
                        <div class="px-6 mt-16">
                            <h1 class="font-bold text-3xl text-center mb-1">Enes KAYNAK</h1>
                            <p class="text-gray-800 text-sm text-center">Front-end Developer</p>
                            ...
                            <div class="w-full flex justify-center pt-5 pb-5">
                                <a href="https://github.com/eneskaynakk" class="mx-5">
                                    <div aria-label="Github" role="img">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#718096" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-github">
                                            <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path>
                                        </svg>
                ...
                <div role="listitem" class="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
                    <div class="rounded overflow-hidden shadow-md bg-white">
                        ...
                        <div class="px-6 mt-16">
                            <h1 class="font-bold text-3xl text-center mb-1">Enes KAYNAK</h1>
                            <p class="text-gray-800 text-sm text-center">Back-end Developer</p>
                ...
                <div role="listitem" class="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
                    <div class="rounded overflow-hidden shadow-md bg-white">
                        ...
                        <div class="px-6 mt-16">
                            <h1 class="font-bold text-3xl text-center mb-1">Enes KAYNAK</h1>
                            <p class="text-gray-800 text-sm text-center">QA Tester</p>
                            <p class="text-center text-gray-600 text-base pt-3 font-normal">An avid open-source developer who loves to be creative and inventive. I have 20 years of experience in the field. The emphasis on innovation and technology in our companies.</p>
                            <div class="w-full flex justify-center pt-5 pb-5">
                                <a href="https://github.com/eneskaynakk" class="mx-5">
                                    <div aria-label="Github" role="img">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#718096" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-github">
                ...
                <div role="listitem" class="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
                    <div class="rounded overflow-hidden shadow-md bg-white">
                        ...
                        <div class="px-6 mt-16">
                            <h1 class="font-bold text-3xl text-center mb-1">Enes KAYNAK</h1>
                            <p class="text-gray-800 text-sm text-center">Product Owner</p>
                ...
                <div role="listitem" class="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
                    <div class="rounded overflow-hidden shadow-md bg-white">
                        ...
                        <div class="px-6 mt-16">
                            <h1 class="font-bold text-3xl text-center mb-1">Enes KAYNAK</h1>
                            <p class="text-gray-800 text-sm text-center">Data Analyst</p>
